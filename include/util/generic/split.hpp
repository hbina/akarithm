...
template <
    typename ValueTy, typename OutputIteratorInner = std::vector<ValueTy>,
    ...
    typename = std::enable_if<std::is_same_v<
        typename std::iterator_traits<InputIterator>::value_type, ValueTy>>>
static constexpr auto split(InputIterator iter_begin, InputIterator iter_end,
...
template <typename ValueTy, typename OutputIteratorInner = std::vector<ValueTy>,
          typename OutputIteratorOuter = std::vector<OutputIteratorInner>,
          typename InputIterator, typename UnaryPredicate,
          typename = std::enable_if<std::is_same_v<
              typename std::iterator_traits<InputIterator>::value_type,
              typename std::iterator_traits<
                  typename OutputIteratorInner::iterator>::value_type>>>
static constexpr auto split_if(InputIterator iter_begin, InputIterator iter_end,
