...
#include "akarithm/problem_494.hpp"
...
TEST_CASE("problem_494")
{
    ...
    const int result_bruteForce = static_cast<int>(akarithm::findTargetSumWays_bruteForce(input_1, input_2));
    const int result_memoization = static_cast<int>(akarithm::findTargetSumWays_memoization(input_1, input_2));
