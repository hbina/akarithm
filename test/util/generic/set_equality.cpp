...
TEST_CASE("akarithm::set_equality 1") {
  const std::vector<int> input_1 = {1, 2, 3, 4, 5, 6};
  const std::vector<int> input_2 = {6, 5, 4, 3, 2, 1};
  const bool expected = true;
  CHECK(expected ==
        akarithm::set_equality(std::cbegin(input_1), std::cend(input_1),
                               std::cbegin(input_2), std::cend(input_2)));
}

TEST_CASE("akarithm::set_equality 2") {
  const std::vector<int> input_1 = {1, 2, 3, 4, 5, 6};
...
TEST_CASE("akarithm::set_equality 3") {
